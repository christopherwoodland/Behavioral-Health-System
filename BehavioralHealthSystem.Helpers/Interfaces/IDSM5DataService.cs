...
public interface IDSM5DataService
{
    ...
    /// </summary>
    /// <param name="pdfUrl">URL of the DSM-5 PDF</param>
    ...
    Task<DSM5ExtractionResult> ExtractDiagnosticCriteriaAsync(string pdfUrl, string? pageRanges = null, bool autoUpload = false);
