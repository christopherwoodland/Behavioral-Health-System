...
public class RiskAssessment
{
    ...
    public int RiskScore { get; set; } // 0 when indeterminate; otherwise 1-10

    [JsonPropertyName("evidenceSufficiency")]
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    public string? EvidenceSufficiency { get; set; }

    [JsonPropertyName("modelSignalRiskLevel")]
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    public string? ModelSignalRiskLevel { get; set; }
