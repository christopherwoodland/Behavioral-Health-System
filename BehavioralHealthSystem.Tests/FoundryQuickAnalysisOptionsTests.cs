...
[TestClass]
public class FoundryQuickAnalysisOptionsTests
{
    [TestMethod]
    public void Constructor_InitializesSafeDefaults()
    {
        var options = new FoundryQuickAnalysisOptions();
        ...
        Assert.AreEqual("FoundryQuickAnalysis", FoundryQuickAnalysisOptions.SectionName);
    }
}
