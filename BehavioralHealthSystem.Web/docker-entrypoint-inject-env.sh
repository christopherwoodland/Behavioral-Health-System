...
window.__RUNTIME_CONFIG__ = {
  ...
  VITE_AZURE_API_CLIENT_ID: "${VITE_AZURE_API_CLIENT_ID:-${VITE_AZURE_CLIENT_ID:-}}",
  ...
  VITE_AZURE_OPENAI_REALTIME_RESOURCE_NAME: "${VITE_AZURE_OPENAI_REALTIME_RESOURCE_NAME:-}",
  ...
  VITE_AIR_GAP_MODE: "${VITE_AIR_GAP_MODE:-false}",
  VITE_FFMPEG_CORE_BASE_URL: "${VITE_FFMPEG_CORE_BASE_URL:-/ffmpeg-core}",
