...
// Assign Cognitive Services OpenAI User role to Function App for Content Understanding (OpenAI completions)
resource contentUnderstandingOpenAiRoleAssignment 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
  name: guid(contentUnderstandingAccount.id, functionAppPrincipalId, cognitiveServicesOpenAiUserRoleId)
  scope: contentUnderstandingAccount
  properties: {
    roleDefinitionId: subscriptionResourceId('Microsoft.Authorization/roleDefinitions', cognitiveServicesOpenAiUserRoleId)
    principalId: functionAppPrincipalId
...
// Assign Cognitive Services Speech User role to Function App for Content Understanding (Speech transcription)
resource contentUnderstandingSpeechRoleAssignment 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
  name: guid(contentUnderstandingAccount.id, functionAppPrincipalId, cognitiveServicesSpeechUserRoleId)
  scope: contentUnderstandingAccount
  properties: {
    roleDefinitionId: subscriptionResourceId('Microsoft.Authorization/roleDefinitions', cognitiveServicesSpeechUserRoleId)
    principalId: functionAppPrincipalId
