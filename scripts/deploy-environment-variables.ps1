...
$environmentVariables = @(
    "AzureWebJobsStorage=DefaultEndpointsProtocol=https;AccountName=aistgvi;AccountKey=REDACTED_AZURE_STORAGE_ACCOUNT_KEY==;EndpointSuffix=core.windows.net",
    "FUNCTIONS_WORKER_RUNTIME=dotnet-isolated",
    "KINTSUGI_API_KEY=REDACTED_KINTSUGI_API_KEY",
    ...
    "AZURE_OPENAI_API_KEY=REDACTED_AZURE_OPENAI_API_KEY",
    ...
    "DocumentIntelligenceKey=REDACTED_DOCUMENT_INTELLIGENCE_KEY",
    "DSM5_DOCUMENT_INTELLIGENCE_ENDPOINT=https://doc-intel-behavioral-health.cognitiveservices.azure.com/",
    "DSM5_DOCUMENT_INTELLIGENCE_KEY=REDACTED_DOCUMENT_INTELLIGENCE_KEY",
