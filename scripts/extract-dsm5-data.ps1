...
$LocalSettingsPath = Join-Path $SolutionRoot "BehavioralHealthSystem.Functions\local.settings.json"
$FunctionsProjectPath = Join-Path $SolutionRoot "BehavioralHealthSystem.Functions\BehavioralHealthSystem.Functions.csproj"
